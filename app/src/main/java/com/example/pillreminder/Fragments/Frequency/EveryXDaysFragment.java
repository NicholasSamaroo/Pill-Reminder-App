 ...
 */
public class EveryXDaysFragment extends Fragment implements EveryXDaysPickerFragment.returnEveryXDaysNumPickerValue {
     ...
     * @return A new instance of fragment EveryXDaysFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static EveryXDaysFragment newInstance(String param1, String param2) {
        EveryXDaysFragment fragment = new EveryXDaysFragment();
    ...
    public void displayNumPicker() {
        DialogFragment newFragment = new EveryXDaysPickerFragment();
