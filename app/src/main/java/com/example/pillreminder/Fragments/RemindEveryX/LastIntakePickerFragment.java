 ...
 */
public class LastIntakePickerFragment extends DialogFragment {
     ...
     * @return A new instance of fragment LastIntakePickerFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static LastIntakePickerFragment newInstance(String param1, String param2) {
        LastIntakePickerFragment fragment = new LastIntakePickerFragment();
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final NumberPicker hourPicker = inflateNumPicker.findViewById(R.id.lastIntakeHours);
        ...
        final NumberPicker minutePicker = inflateNumPicker.findViewById(R.id.lastIntakeMinutes);
        ...
        final NumberPicker amPmPicker = inflateNumPicker.findViewById(R.id.lastIntakeAmOrPm);
        ...
        builder.setView(inflateNumPicker)
                ...
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        callback.lastIntakeHourAndMinutes(hourValue, minuteValue, amPmValue);
                    }
                })
