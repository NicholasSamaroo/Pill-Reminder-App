 ...
 */
public class FirstIntakePickerFragment extends DialogFragment implements TimePickerDialog.OnTimeSetListener {
    ...
    public static FirstIntakePickerFragment newInstance(String param1, String param2) {
        return new FirstIntakePickerFragment();
    }
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        TimePicker firstIntakeTimePicker = inflateNumPicker.findViewById(R.id.firstIntakeTimePicker);
        firstIntakeTimePicker.setIs24HourView(true);
    ...
    public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
        ...
        if(hourOfDay < 12) {
            amPm = "AM";
            callback.firstIntakeHourAndMinutes(hourOfDay,minutePrecede,minute,amPm);
            ...
            callback.firstIntakeHourAndMinutes(currentHour,minutePrecede,minute,amPm);
        }
    }
}